...
<body class="layout-container ls-top-navbar si-l3-md-up si-r3-lg-up">
        <jsp:include page="header.jsp"></jsp:include> 
 				
  <!-- Sidebar -->
  <div class="sidebar sidebar-right si-si-3 sidebar-visible-lg-up ls-top-navbar-xs-up sidebar-light bg-white" id="sidebarRight" data-position="right" data-scrollable data-visible="lg-up">
