...
<div class="bmd-layout-container bmd-drawer-f-l ">
               ...
               <div class="list-group">
                   ...
                   <a href="#" class="list-group-item list-group-item-action list-group-sidebar disabled pt-3">
                    ...
                    <a href="#" class="list-group-item list-group-item-action list-group-sidebar no-hover">
                        <i class="fas fa-circle" style="width:.5em;color:#007bff;"></i>
  ...
  <div class="row">
		...
		<div class="col-xs-12">
			...
			<div class="text-secondary" >
				<a href="#">Home </a> / <a href="#" class="active" >Session Plan Dashboard</a> 
			</div>
	...
	<span style="color:#d1c4e9; font-size:14px;">Module : 1</span> <br>
  ...
  <div class="card-body small pt-0 pb-0 ">
  ...
  <div class = "col-12 m-0  text-center">
			...
			<div class = "col-3 m-0 p-0 moduleCardIconLinks  border border-muted">
				<a href="#" class="btn btn-outline-light card-link btn-block">
					<i class="fa-solid fa-book fs-18 text-muted" ></i>
	            </a>
			</div>
			<div class = "col-3 m-0 p-0 moduleCardIconLinks  border border-muted">
				<a href="#" class="btn btn-outline-light card-link btn-block">
					<i class="fa-regular fa-window-maximize fs-18 text-muted" ></i>
				</a>
				
			</div>
			<div class = "col-3 m-0 p-0 moduleCardIconLinks  border border-muted">
				<a href="#" class="btn btn-outline-light card-link btn-block">
					<i class="fa-solid fa-circle-question fs-18 text-muted" ></i>
	            </a>
			</div>
			</div>
		</div>
	...
	<span style="color:#d1c4e9; font-size:14px;">Module : 2</span> <br>
  ...
  <div class = "col-12 m-0  text-center">
	...
	<span style="color:#d1c4e9; font-size:14px;">Module : 3</span> <br>
	Introduction to the Field of Organizational Behavior 
	</h6>
    			<a href="#" class="cards-settings">
					<i class="fa-solid fa-gear text-light" ></i>
  ...
  <div class = "col-12 m-0  text-center">
	...
	<span style="color:#d1c4e9; font-size:14px;">Module : 4</span> <br>
  ...
  <div class = "col-12 m-0  text-center">
	...
	<span style="color:#d1c4e9; font-size:14px;">Module : 5</span> <br>
  ...
  <div class = "col-12 m-0  text-center">
	...
	<h6 class="card-title sessionPlanHomeCardTitle " style="background-color:#009688">
		<span style="color:#d1c4e9; font-size:14px;">Module : 6</span> <br>
  ...
  <div class = "col-12 m-0  text-center">
	  ...
	  <div class="card">
	<h6 class="card-title sessionPlanHomeCardTitle " style="background-color:#673ab7">
	<span style="color:#d1c4e9; font-size:14px;">Module : 7</span> <br>
  ...
  <div class = "col-12 m-0  text-center">
	  ...
	  <div class="card">
	<h6 class="card-title sessionPlanHomeCardTitle "  style="background-color:#3f51b5">
	<span style="color:#d1c4e9; font-size:14px;">Module : 8</span> <br>
	Individual Behavior, Personality, and Values
  ...
  <div class="card-body small pt-0 pb-0 ">
	...
	<div class = "col-12 m-0  text-center">
	  ...
	  <div class="card">
	<h6 class="card-title sessionPlanHomeCardTitle "  style="background-color:#9c27b0">
	<span style="color:#d1c4e9; font-size:14px;">Module : 9</span> <br>
  ...
  <div class = "col-12 m-0">
	  ...
	  <div class="card">
	<h6 class="card-title sessionPlanHomeCardTitle "  style="background-color:#039be5">
	<span style="color:#d1c4e9; font-size:14px;">Module : 10</span> <br>
	Conflict and Negotiation in the Workplace
	</h6>
    			<a href="#" class="cards-settings">
					<i class="fa-solid fa-gear text-light" ></i>
  ...
  <div class="card-body small pt-0 pb-0 ">
	...
	<div class = "row">
	  ...
	  <div class="card">
	<h6 class="card-title sessionPlanHomeCardTitle "  style="background-color:#00acc1">
	<span style="color:#d1c4e9; font-size:14px;">Module : 11</span> <br>
	Perceiving Ourselves and Others in Organizations
  ...
  <div class="card-body small pt-0 pb-0 ">
	...
	<div class = "">
	  ...
	  <div class="card">
	<h6 class="card-title sessionPlanHomeCardTitle "  style="background-color:#009688">
	<span style="color:#d1c4e9; font-size:14px;">Module : 12</span> <br>
	Power and Influence in the Workplace 
	</h6>
    			<a href="#" class="cards-settings">
					<i class="fa-solid fa-gear text-light" ></i>
...
</li><li>	To be better informed about the employees in terms of their attitudes, personatilies, perception and how this directly effects the organisationâs success 
		</li>
		</ul>
...
Organisationâs Culture and its impact on productivity<br>
...
$(".col-md-3").click(function() {
  window.location.href = "http://test-studentzone-ngasce.nmims.edu/ltidemo/viewVideoGallery";
});
</script>
</body>
</html>